...
|When	|Duration | What	|
| --- | --- | --- |
| Jun 4 2026 | 16:30-17:15 PT 45min (unplanned) | `/sdf/home`, `/sdf/group`, `/sdf/sw` outage during routine firmware upgrades for one model of server - An issue with the vendor's firmware upgrade tooling briefly stopped cooling fans in each server during each upgrade. A small percentage of servers overheated during this time, impacting `sdfhome` storage. |
